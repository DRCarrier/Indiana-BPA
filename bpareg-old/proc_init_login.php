        ...
        {          
            ...
            if ($count == 0) 
            {
                ...
                {                    
                    ...
                    $con->query($sql);
                    echo '<form name="form1" method="post" action="/new/index-text-main.php?school_number=<?php echo $school_number;?>"><input type="submit" value="Next" name="Next" id="Submit" /></form>';
                } 
            }
